...
class Video:
    ...
    def runVideo(self):
        ...
        while cap.isOpened():
            ...
            image = draw_landmarks_on_image_face(image.numpy_view(), face_landmarker_result)
            ...
            if cv2.waitKey(1) & 0xFF == ord('q'):
                ...
                print("face landmarks" + str(face_landmarker_result.face_landmarks))

                spring_boot_url = "http://localhost:8080/test/numeric_data"

                facelandmarks_xyz = []

                for facelandmarks in face_landmarker_result.face_landmarks:
                    for landmark in facelandmarks:
                        facelandmarks_xyz.append([landmark.x, landmark.y, landmark.z])

                data_payload = json.dumps(facelandmarks_xyz)
                ...
                print("facelandmarks_xyz" + str(facelandmarks_xyz))
